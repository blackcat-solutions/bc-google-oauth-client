...
/**
 * An enhanced version of {@link com.google.api.client.auth.oauth.OAuthParameters} that allows the
 * session handle to be passed.
 */
public final class OAuthParameters implements HttpExecuteInterceptor, HttpRequestInitializer {
	...
	/**
	 * The long-running session handle, for token renewal.
	 */
	 ...
	 *
	 * @throws java.security.GeneralSecurityException general security exception
	 */
